...
import static com.ichi2.anki.FlashCardsContract.AUTHORITY_URI;
...
public class AnkiDroidHelper {
    ...
    String addMediaFromUri(
        ...
        Log.d("msg :", "fileUri.toString: " + fileUri.toString());
        preferredName = preferredName.replace(" ", "_");
        contentValues.put(AnkiMedia.PREFERRED_NAME, preferredName);

        try {
            Log.d("msg :", "AnkiMedia.CONTENT_URI: " + AnkiMedia.CONTENT_URI);
            Log.d("msg :", "contentValues: " + contentValues);
            Uri returnUri = mContext.getContentResolver().insert(AnkiMedia.CONTENT_URI, contentValues);
